...
const saveTmpAcc = (accs) => {
  ...
  sessionStorage.setItem("accommodations", JSON.stringify(accommodations.value ? accommodations.value : []));
};
...
<template>
  ...
  <div class="container relative lg:w-[50vw] z-0">
    <div class="flex flex-col m-5">
      ...
      <div class="my-5">
        <RouterLink :to="{ name: 'planModifyAccommodation' }" @click="saveTmpPlan" push>
      ...
      <div class="my-5">
        ...
        <div v-for="day in planDayRange" class="ms-5 mt-5">
          <RouterLink :to="{ name: 'planModifyAttraction', query: { day } }" @click="saveTmpPlan" push>
